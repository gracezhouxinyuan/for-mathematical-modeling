...
| **GRA（灰色关联分析）** | 灰色理论,相似度度量 | 小样本评价,关联分析 | ⭐⭐⭐ |
| **模糊综合评价** | 模糊集合论 | 模糊信息处理,综合判断 | ⭐⭐⭐ |
| **RSR（秩和比）** | 非参数统计 | 等级资料评价 | ⭐⭐ |
...
灰色系统论中的方法，通过计算**参考数列与比较数列的灰色关联度**来评价相似性。
...
**核心公式：** 
$$\gamma(x_0(k), x_i(k)) = \frac{1 + |s_0| + |s_i|}{1 + |s_0| + |s_i| + |s_0 - s_i|}$$
