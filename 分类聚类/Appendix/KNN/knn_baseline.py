...
def main() -> None:
    ...
    pd.DataFrame(confusion_matrix(y_test, pred)).to_csv(DATA_DIR / "results_baseline_confusion.csv", index=False, encoding="utf-8-sig")

    print(f"baseline accuracy={accuracy_score(y_test, pred):.4f}")
